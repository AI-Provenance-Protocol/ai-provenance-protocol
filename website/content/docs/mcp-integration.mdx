...
description: How to use APP alongside the Model Context Protocol (MCP). Embed provenance metadata in MCP tool responses, use the MCP extension namespace, and build provenance chains across multi-step AI workflows.
---
