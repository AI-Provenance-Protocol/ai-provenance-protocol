...
description: How APP's public verification endpoints work — Level 1 generation ID lookup and Level 2 content hash matching — allowing any third party to confirm AI provenance claims.
---
...
[merchi.ai](https://merchi.ai) operates a conformant public verification endpoint. You can test a real generation:
...
```bash
npx app-validator verify a6986899-bb06-461b-bbf7-c689cad09cbd \
