---
title: SDKs & CLI
description: Official TypeScript SDK and validator CLI for implementing the AI Provenance Protocol — install from npm, generate metadata, embed, validate, and verify in minutes.
---
