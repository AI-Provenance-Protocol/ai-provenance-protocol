...
description: Learn how to associate AI Provenance Protocol metadata with generated content using three modes — inline JSON, HTTP headers, and linked metadata — and how to combine them.
---
