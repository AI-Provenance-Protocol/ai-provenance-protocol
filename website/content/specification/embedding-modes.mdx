...
The `_app` key is embedded at the top level of JSON output:

```json
{
  "title": "Example content",
  "_app": { "app_version": "1.0.0", "ai_generated": true, "..." : "..." }
}
```

### Rules
- The key MUST be `_app`
- MUST be at the top level of the JSON object
- Systems SHOULD preserve `_app` through transformations
