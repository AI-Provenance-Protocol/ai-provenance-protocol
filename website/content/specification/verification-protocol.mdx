---
title: Verification Protocol — APP Specification
description: Normative specification for APP's two-level verification protocol — Level 1 generation ID lookup and Level 2 content hash matching. Requirements for platforms implementing public verification endpoints.
---
...
<JsonLd data={{
  ...
  "description": "Normative specification for APP's two-level verification protocol — Level 1 generation ID lookup and Level 2 content hash matching. Requirements for platforms implementing public verification endpoints.",
  "url": "https://aiprovenanceprotocol.io/specification/verification-protocol",
